...
interface UseSimpleRevealOptions {
  threshold?: number;
  rootMargin?: string;
}
...
export const useSimpleReveal = <T extends HTMLElement = HTMLDivElement>(options: UseSimpleRevealOptions = {}) => {
...
export default useSimpleReveal;
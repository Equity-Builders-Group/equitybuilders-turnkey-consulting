        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-2 items-center max-w-7xl">
          ...
          <div className="space-y-12 order-2 lg:order-1 text-center lg:text-left px-2 sm:px-0">
            ...
            >
              ...
              <div className="hidden flex flex-col lg:flex-row items-center justify-center lg:justify-start gap-4 text-white/90">
          ...
          <div 
            ref={phoneRef}
            className={`relative flex justify-center lg:pl-24 scroll-reveal-fade-up ${phoneVisible ? 'visible' : ''}`}
          >
